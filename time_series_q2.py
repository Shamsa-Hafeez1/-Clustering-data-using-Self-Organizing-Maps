...
# Question 2 : Happiness across years 
# turtle is commented so that it takes less time to run 
...
def clean_data(path, remove, remove1): 
...
# a, id = clean_data('2019.csv', 'Country or region', 'Overall rank')
# a, id = clean_data('2015.csv', 'Country', 'Region')
# a, id = clean_data('2016.csv', 'Country', 'Region')
# a, id = clean_data('2017.csv', 'Country', 'Happiness.Rank')
a, id = clean_data('2018.csv', 'Country or region', 'Overall rank')
